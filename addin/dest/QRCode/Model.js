	...
	declare('QRCode.Model', {
		...
		makeImpl: function (test, maskPattern) {
			...
			if (this.dataCache == null) {
				this.dataCache = _.QRCode.Model.createData(this.typeNumber, this.errorCorrectLevel, this.dataList);
			}
