...
tang.init().block([
    ...
    declare('draw.Charts.types.Bar', _.draw.Charts.types.Abstract, {
        defaults: {
            name: '',
            zIndex: 0,
            itemStyle: {
        ...
        initialize: function(options) {
            ...
            this.BarClass = declare(_.draw.Charts.components.sharps.Rectangle, {
                ctx: this.ctx,
                grid: this.grid,
    ...
    _.draw.Charts.prototype.bar = function(index) {
        var chart,
            chartName,
            id = 0,
            grid = this.grid;
        ...
        if (grid) {
            ...
            _.each(this.series.bar, function(i, options) {
                ...
                if (this.historyCharts[chartName] && this.historyCharts[chartName].type == 'bar') {
                    ...
                    chart = new _.draw.Charts.types.Bar(options, this, options.zIndex);
                    chart.type = 'bar';
