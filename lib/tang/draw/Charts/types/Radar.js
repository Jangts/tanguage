...
tang.init().block([
    ...
    '$_/draw/Charts/components/sharps/Line',
    ...
    declare('draw.Charts.types.Radar', _.draw.Charts.types.Abstract, {
        ...
        initialize: function(options) {
            ...
            this.LineClass = declare(_.draw.Charts.components.sharps.Line, {
                ctx: this.ctx,
                radar: this.radar,
            ...
            this.PointClass = declare(_.draw.Charts.components.sharps.Point, {
    ...
    _.draw.Charts.prototype.radar = function() {
        var chart,
            chartName,
            id = 0,
        ...
        if (radar) {
            _.each(this.series.radar, function(i, options) {
                ...
                if (this.historyCharts[chartName] && this.historyCharts[chartName].type == 'radar') {
                    ...
                    chart = new _.draw.Charts.types.Radar(options, this, options.zIndex);
                    chart.type = 'radar';
