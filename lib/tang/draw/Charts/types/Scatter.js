...
tang.init().block([
    ...
    declare('draw.Charts.types.Scatter', _.draw.Charts.types.Abstract, {
    ...
    _.draw.Charts.prototype.scatter = function() {
        var chart,
            chartName,
            id = 0,
            grid = this.grid;
        ...
        if (grid) {
            ...
            _.each(this.series.scatter, function(i, options) {
                ...
                if (this.historyCharts[chartName] && this.historyCharts[chartName].type == 'scatter') {
                    ...
                    chart = new _.draw.Charts.types.Scatter(options, this, options.zIndex);
                    chart.type = 'scatter';
