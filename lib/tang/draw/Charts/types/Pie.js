...
tang.init().block([
    ...
    declare('draw.Charts.types.Pie', _.draw.Charts.types.Abstract, {
        ...
        initialize: function(options) {
            ...
            if (_.util.isArr(options.radius) && options.radius[2]) {
                if (_.util.isPercent(options.radius[2])) {
                    emphasisRadius = maxRadius * parseInt(options.radius[2]) / 100
                } else if (_.util.isNumeric(options.radius[2])) {
            ...
            this.ArcClass = declare(_.draw.Charts.components.sharps.Arc, {
                ctx: this.ctx,
    ...
    _.draw.Charts.prototype.pie = function() {
        var chart,
            chartName,
            id = 0;
        _.each(this.series.pie, function(i, options) {
            ...
            if (this.historyCharts[chartName] && this.historyCharts[chartName].type == 'pie') {
                ...
                chart = new _.draw.Charts.types.Pie(options, this, options.zIndex);
                chart.type = 'pie';
