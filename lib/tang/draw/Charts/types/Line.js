...
tang.init().block([
    ...
    declare('draw.Charts.types.Line', _.draw.Charts.types.Abstract, {
    ...
    _.draw.Charts.prototype.line = function() {
        var chart,
            chartName,
            id = 0;
        if (this.grid) {
            ...
            _.each(this.series.line, function(i, options) {
                ...
                if (this.historyCharts[chartName] && this.historyCharts[chartName].type == 'line') {
                    ...
                    chart = new _.draw.Charts.types.Line(options, this, options.zIndex);
                    chart.type = 'line';
