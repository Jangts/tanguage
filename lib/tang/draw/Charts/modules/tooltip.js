...
tang.init().block([
    ...
    _.extend(_.draw.Charts.util.defaults, {
        tooltip: {
            show: true,
            type: 'item',
            zIndex: 0,
    ...
    _.draw.Charts.prototype.showTooltip = function(segments, forceRedraw, showMulti) {
        if (_.draw.Charts.components.Tooltip) {
            ...
            var options = {
                ...
                tooltipXPadding: _.util.isArr(tooltip.padding) ? tooltip.padding[0] : (_.util.isNumeric(tooltip.padding) ? parseFloat(tooltip.padding) : 5),
                tooltipYPadding: _.util.isArr(tooltip.padding) ? tooltip.padding[1] : (_.util.isNumeric(tooltip.padding) ? parseFloat(tooltip.padding) : 5),
            ...
            if (segments.length > 0) {
                if (showMulti) {
                    ...
                    new _.draw.Charts.components.MultiTooltip({
                        x: medianPosition.x,
                        y: medianPosition.y,
                    ...
                    new _.draw.Charts.components.Tooltip({
