...
tang.init().block([
    ...
    _.draw.Charts.prototype.buildGrid = function() {
        var grid = _.obj.deepMerge(_.draw.Charts.util.defaults.grid, this.options.grid || {}),
            xAxis = _.obj.deepMerge(_.draw.Charts.util.defaults.xAxis, this.options.xAxis || {}),
            yAxis = _.obj.deepMerge(_.draw.Charts.util.defaults.yAxis, this.options.yAxis || {});
        ...
        if (this.grid === null) {
            this.grid = new _.draw.Charts.components.scales.Grid(gridOptions);
