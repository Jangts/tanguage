...
tang.init().block([
    ...
    _.draw.Charts.prototype.buildRadar = function() {
        var radar = _.obj.deepMerge(_.draw.Charts.util.defaults.radar, this.options.radar || {});
        ...
        if (this.radarpolar === null) {
            this.radarpolar = new _.draw.Charts.components.scales.Polar(polarOptions);
