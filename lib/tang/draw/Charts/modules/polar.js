...
tang.init().block([
    ...
    '$_/draw/Charts/components/scales/Polar'
    ...
    var helpers = _.draw.Charts.util.helpers,
        events = _.draw.Charts.util.events;
    ...
    _.draw.Charts.prototype.buildPolar = function() {
        var polar = _.obj.deepMerge(_.draw.Charts.util.defaults.polar, this.options.polar || {}),
            angleAxis = _.obj.deepMerge(_.draw.Charts.util.defaults.angleAxis, this.options.angleAxis || {}),
            radiusAxis = _.obj.deepMerge(_.draw.Charts.util.defaults.radiusAxis, this.options.radiusAxis || {});
        ...
        if (this.polar === null) {
            this.polar = new _.draw.Charts.components.scales.Polar(polarOptions);
