...
tang.init().block([
    ...
    declare('draw.Charts.components.scales.Grid', _.draw.Charts.components.Abstract, {
        _init: function(configuration) {
            ...
            this.font = _.draw.canvas.fontString(this.xLabelFontSize, this.xLabelFontStyle, this.xLabelFontFamily);
            //this.save();
            this.fit();
        },
        ...
        buildYLabels: function() {
            ...
            this.yLabelWidth = (this.display && this.yLabelsShow) ? _.draw.canvas.longestText(this.ctx, this.font, this.yLabels) + 10 : 0;
        ...
        buildXLabels: function() {
            ...
            this.xLabelWidth = (this.display && this.xLabelsShow) ? _.draw.canvas.longestText(this.ctx, this.font, this.xLabels) + 4 : 0;
