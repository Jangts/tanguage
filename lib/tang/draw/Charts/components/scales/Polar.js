...
tang.init().block([
    ...
    '$_/draw/Charts/components/Abstract'
    ...
    var helpers = _.draw.Charts.util.helpers,
        getMax = function(steps, value) {
            var stepValue = Math.ceil(value / steps);
            return stepValue * steps;
        };

    declare('draw.Charts.components.scales.Polar', _.draw.Charts.components.Abstract, {
        ...
        fitDrawingAreaR: function() {
            var largestPossibleRadius = this.radius - this.radiusLabelFontSize - 5,
                ...
                radiusReductionLeft,
                maxWidthRadius;
            this.ctx.font = _.draw.canvas.fontString(this.angleLabelFontSize, this.angleLabelFontStyle, this.angleLabelFontFamily);
            ...
            radiusReductionRight = (_.util.isNumber(radiusReductionRight)) ? radiusReductionRight : 0;
            radiusReductionLeft = (_.util.isNumber(radiusReductionLeft)) ? radiusReductionLeft : 0;
                ...
                _.each(this.radiusLabels, function(index, label) {
                    if (index > 0) {
                        ...
                        if (this.radiusLabelsShow) {
                            ctx.font = _.draw.canvas.fontString(this.radiusLabelFontSize, this.radiusLabelFontStyle, this.radiusLabelFontFamily);
        ...
        drawAngleLabels: function(ctx, i) {
            if (this.angleLabelsShow) {
                ...
                ctx.font = _.draw.canvas.fontString(this.angleLabelFontSize, this.angleLabelFontStyle, this.angleLabelFontFamily);
