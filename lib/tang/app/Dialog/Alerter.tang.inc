                ...
                handler = function(event) {
                    ...
                    if (type && type != '') {
                        ...
                        switch (type) {
                            case 'confirm':
                            case 'resolve':
                                _.util.isFn(msg.done) && msg.done.call(msg);
                                break;
                            case 'reject':
                                _.util.isFn(msg.fail) && msg.fail.call(msg);
                                break;
                            case 'cancel':
                                _.util.isFn(msg.undo) && msg.undo.call(msg);
                                break;
                        }
                        _.util.isFn(msg.always) && msg.always.call(msg);
                        that.listener();
                    }
                };
