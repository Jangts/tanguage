 ...
 *
 * Datetime: Thu, 02 Aug 2018 07:23:00 GMT
 */;
void
...
function(root, factory) {
    ...
    var template = 'if(this instanceof constructor){'
    + 'this._private = {};'
    ...
    if (storage.core.HTMLElement) {
        ...
        var mains = storage.core.HTMLElement.getAttribute('data-mains');
        var debug = storage.core.HTMLElement.getAttribute('data-tanguage-debug');
        if (config) {
            var url = url + '.js';
            loadURL(url, '$Config');
        }
