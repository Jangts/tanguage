...
tang.init().block([
    ...
    declare('see.Sticker', {
        ...
        _init: function(elem, options) {
            this.Element = _.util.isElement(elem) ? elem : doc.getElementById(elem);
        ...
        show: function(callback) {
            ...
            $(this.Element).show(this.animationDuration, function() {
                _.util.isFn(callback) && callback.call(that);
            });
        },
        ...
        register: function(scrollTop, downCallback, upCallback) {
            ...
            _.util.isFn(downCallback) && handlers[this.uid][scrollTop].down.push(downCallback);
            _.util.isFn(upCallback) && handlers[this.uid][scrollTop].up.push(upCallback);
        }
    });
});