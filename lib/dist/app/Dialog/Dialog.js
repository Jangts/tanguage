 ...
 *
 * Datetime: Thu, 02 Aug 2018 10:48:46 GMT
 */;
// tang.config({});
tang.init().block([], function (pandora, root, imports, undefined) {
    tang.init().block(['$_/util/COM', '$_/dom/Elements'], function (pandora_1, root_1, imports, undefined) {
        var _ = pandora_1;
        var declare = pandora_1.declareClass;
        var doc = root_1.document;
        var console = root_1.console;
        ...
        declare('see.popup.Dialog', _.util.COM, {
            ...
            docHeightMax: 0,
            _init: function (elem) {
                this.HTMLElement = elem || function () {
                ...
                this.mask = $('.popup-mask', this.HTMLElement).get(0);
                this.document = $('.popup-document', this.HTMLElement).get(0);
            },
            builder: function () {
                _.dom.setStyle(this.HTMLElement, 'display', 'none');
                _.dom.setStyle(this.HTMLElement, 'z-index',  -100);
                if (this.mask) {
            ...
            on: function () {
                this.state = true;
                _.dom.setStyle(this.HTMLElement, 'display', 'block');
                return this;
            },
            off: function () {
                this.state = false;
            ...
            show: function (content) {
                if (!this.status) {
                    this.on();
                    _.dom.setStyle(this.HTMLElement, 'z-index', this.layerIndex);
            ...
            render: function (content) {
                var size = _.dom.getSize(this.HTMLElement);
                ...
                if (content) {
                    if (_.util.isEl(content)) {
                        this.Doc.appendChild(content);
                    }
                    else if (_.util.isStr(content)) {
            ...
            bind: function () {
                var that = this;
                new _.dom.Events(root_1).push('resize', null, null, function () {
