 ...
 *
 * Datetime: Tue, 17 Jul 2018 03:48:09 GMT
 */;
// tang.config({});
tang.init().block([
    '$_/arr/',
    ...
    var Pie = pandora.declareClass(Charts.Type, {
        ...
        update: function (data) {
            ...
            pandora.each(this.segments, function (index, segment) {
                ...
                segment.outerRadius = this.options.animateScale ? 0 : this.style.outerRadius;
                segment.innerRadius = this.options.animateScale ? 0 : this.style.innerRadius;
