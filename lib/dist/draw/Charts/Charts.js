 ...
 *
 * Datetime: Thu, 02 Aug 2018 09:53:44 GMT
 */;
// tang.config({});
tang.init().block([
    '$_/arr/',
    ...
    pandora.declareClass('draw.Charts', {
        ...
        resize: function () {
            ...
            var newHeight = this.options.maintainAspectRatio ? newWidth/this.ratio : draw.Charts.helpers.getMaximumHeight(this.HTMLElement);
            this.width = newWidth;
