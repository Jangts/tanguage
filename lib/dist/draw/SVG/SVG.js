 ...
 *
 * Datetime: Mon, 30 Jul 2018 22:32:47 GMT
 */;
// tang.config({});
tang.init().block([
    '$_/util/',
    ...
    pandora.declareClass('draw.SVG', {
        ...
        text: function (x, y, textContent, data) {
            ...
            text.span = function (x, y, textContent, data) {
                ...
                tspan.Element.textContent = textContent_28;
                if (data_28) {
                    pandora.each(data_28, function (attr) {
    ...
    var geo = function (rootnode, width, height, data, range, after, type) {
        ...
        svg.coordinateSwitch = function (coordinate, type) {
            type_35 = type_35 || 'CosLat';
            var x = types[type_35] ? types[type_35](coordinate, mapCenter, scale, center): types.CosLat(coordinate, mapCenter, scale, center);
