...
tang.init().block([
    ...
    declare('form.Data', {
        ...
        appendForm: function(form) {
            var form = _.util.isEl(form) ? form : document;
            var data = {};
            var selecteds = [];
        ...
        checkValue: function(doneCallback, failCallback) {
            ...
            if (error_num > 0) {
                _.util.isFn(failCallback) && failCallback.call(this, error_arr);
            } else {
                _.util.isFn(doneCallback) && doneCallback.call(this);
            }
            return this;
        },
        ...
        submit: function(options) {
            ...
            var doneCallback = function() {
                ...
                method = _.util.isHttpMethod(method) || 'POST';
