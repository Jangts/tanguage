 ...
 *
 * Datetime: Tue, 29 May 2018 01:37:38 GMT
 */
;
// tang.config({});
tang.init().block([
	...
	pandora.ns('form', function () {
		...
		(function () {
			...
			var regCommand = function (cmd, handler) {
				if (conmands[cmd] === undefined) {
					conmands[cmd] = handler;
					tooltypes[cmd] = 'defaultitem';
				};
			}
			var regCreater = function (cmd, handler, optional) {
			...
			var regDialog = function (cmd, handler) {
			...
			(function () {
				...
				var regEmoticon = function (theme, images) {
