 ...
 *
 * Datetime: Mon, 30 Jul 2018 22:32:48 GMT
 */;
// tang.config({});
tang.init().block([
    '$_/util/',
    ...
    + '</section></div>';
                ...
                toolbar: function (options) {
                    ...
                    for (var i = 0;i < toolbaritems.length;i++) {
                        ...
                        for (var j = 0;j < toolbaritems[i].length;j++) {
                            html += builders_96.tools[tooltypes[toolbaritems[i][j]]].call(this, toolbaritems[i][j]);
                        }
                        html += '</div>';
                    }
                ...
                regCreater: function (cmd, handler, optional) {
                    if (creators[cmd] === undefined) {
                        ...
                        else if (_.util.isStr(handler) && builders_96.tools[handler]) {
        ...
        var checks = (function () {
            ...
            var inheritDecoration = function (node, textDecorationLine) {
                while (node != undefined_131 && node != null) {
        ...
        var events = (function () {
            var resetStateBar = function (editor) {
                ...
                if (event.target.tagName === 'IMG') {
                    ...
                    editor.selectedImage = undefined_164;
                };
            }
                ...
                'toolbar': {
                    ...
                    'mouseup': {
                        ...
                        '.se-show span': function (event) {
                            ...
                            var dialog = _.dom.getClosestParent(this, 'dialog');
        ...
        (function () {
            ...
            pandora.each(creators_266, function (cmd, handler) {
        ...
        (function () {
            ...
            function regEmoticon (theme, images) {
                if (emoticons[theme] === undefined_394) {
