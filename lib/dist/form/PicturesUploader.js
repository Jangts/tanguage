        ...
        builders = {
            ...
            video: function() {
                ...
                _.dom.create('img', this.displayer, {
                    className: 'pic-displayer'
                }).src = this.subtype === 'video16x9' ? _.dirname(block.url) + 'static/video16x9.jpg' : _.dirname(block.url) + 'static/video.jpg';
                this.displayer.src = this.playsrc;
                this.resetter = _.dom.create('i', this.Element, {
                    className: 'pic-resetter',
                    innerHTML: '重置或清除'
        ...
        _init: function(elem, options) {
            ...
            if (_.util.bool.isEl(this.Element)) {
                ...
                if (!this.playsrc) {
                    ...
                    this.playsrc = _.dirname(block.url) + 'static/' + filename;
                }
