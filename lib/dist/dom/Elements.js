 ...
 *
 * Datetime: Sat, 04 Aug 2018 11:26:33 GMT
 */
;
// tang.config({});
tang.init().block([
    ...
    pandora.declareClass('dom.HTMLElements', pandora.Iterator, {
        context: document,
            ...
            if (bool.isOuterHTML(selector)) {
                ...
                if (selector) {
                    switch (typeof (selector)) {
                        ...
                        break;;
                        case 'object':;
                        switch (pandora.util.gettype(selector, true)) {
                            case 'HTMLDocument':;
                            case 'Global':;
                            case 'Element':;
                            ...
                            for (var i = 0;i < arguments[0].length;i++) {
                                pandora.util.gettype(arguments[0][i]) == 'Element' && Elements.push(arguments[0][i]);
                            }
                            break;;
                        }
                        break;;
    ...
    pandora.extend(pandora.dom.HTMLElements.prototype, true, {
        ...
        appendTo: function (selector) {
            var parents = new pandora.dom.HTMLElements(selector);
        ...
        index: function (list) {
            if (pandora.util.isElement(list)) {
        ...
        parent: function () {
            ...
            return new pandora.dom.HTMLElements(pandora.arr.unique(nodes));
        }
    });
    pandora.extend(pandora.dom.HTMLElements.prototype, true, {
    ...
    pandora.extend(pandora.dom.HTMLElements.prototype, true, {
        ...
        undefined: function (data, handler) {
    ...
    var $ = function (selector, context) {
        return new pandora.dom.HTMLElements(selector, context);
    }
    pandora.ns('dom.$', {extend: function (object, rewrite) {
        pandora.extend(pandora.dom.HTMLElements.prototype, rewrite, object);
    }});
    this.module.exports = $;
    pandora('dom.$', $);
});
