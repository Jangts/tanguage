 ...
 *
 * Datetime: Mon, 30 Jul 2018 22:32:43 GMT
 */;
// tang.config({});
tang.init().block([
    '$_/util/',
        ...
        offset: function (value) {
            if (value) {
                switch (typeof value) {
                    ...
                    case 'function':
                    return this.each(function (i) {
                        var style_135 = pandora.dom.getStyle(this);
                        pandora.dom.setStyle(this, 'offsetTop', value(i, style_135.offsetTop));
                        pandora.dom.setStyle(this, 'offsetLeft', value(i, style_135.offsetLeft));
                    });
                }
            }
    ...
    pandora.extend(pandora.dom.Elements.prototype, true, {
        on: function (eventType, selector, data, handler) {
            switch (arguments.length) {
                case 3:
                handler = bool.isFn(data) ? data : undefined_144;
                data = null;
                break;
                case 2:
                handler = bool.isFn(selector) ? selector : undefined_144;
                selector = null;
                data = null;
                break;
            }
