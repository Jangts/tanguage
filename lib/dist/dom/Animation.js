 ...
 *
 * Datetime: Sat, 04 Aug 2018 11:26:32 GMT
 */
;
// tang.config({});
tang.init().block([
    ...
    pandora.declareClass('dom.Animation', pandora.Iterator, {
        ...
        cut: function (options) {
            ...
            for (var i in options.to) {
                this.mc[i] = {
                    from: options.from && typeof(options.from[i]) != 'undefined' ? this.rgbFormat(options.from[i]): this.rgbFormat(pandora.dom.getStyle(this.HTMLElement, i)),
        ...
        play: function (loop, callback) {
            if (this.playback && this.length > 0) {
                ...
                if (this.looped < loop || loop ==  -1) {
                    ...
                    callback && callback.call(this.HTMLElement, this.data);
                    this.length = 0;
                    this.curScene = 0;
                    this.playback = true;
                }
        ...
        enterClip: function (callback) {
            ...
            this.timer = setInterval(function () {
                if (that.curFrame >= that.frames) {
                    that.stop();
                    callback && callback.call(that.HTMLElement, that.looped);
            ...
            for (var prop in this.mc) {
                ...
                if (typeof(from) == 'number' && typeof(to) == 'number') {
                    ...
                    if (/^(\+|-)?\d+%$/.test(from)) {
                        ...
                        var parent = /(width|left|right)/i.test(prop) ? parseFloat(pandora.dom.getStyle(this.HTMLElement.parentNode, 'width')):parseFloat(pandora.dom.getStyle(this.HTMLElement.parentNode, 'height'));
                ...
                pandora.dom.setStyle(this.HTMLElement, prop, ds);
            }
            return this;
        },
        complete: function () {},
    ...
    var animator = function (elem, options) {
        if (elem) {
