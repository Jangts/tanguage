 ...
 *
 * Datetime: Mon, 16 Jul 2018 15:11:18 GMT
 */;
// tang.config({});
tang.init().block([
    '$_/util/',
    ...
    pandora.declareClass('view.Scrollbar', Abstract, {
        Element: document,
    ...
    pandora.extend(pandora.view.Scrollbar, {
        Abstract: Abstract
    });
    this.module.exports = view.Scrollbar;
});
